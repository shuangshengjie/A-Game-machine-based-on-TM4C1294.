...
uint8_t I2C::rxReadIndex = 0;
uint8_t I2C::rxWriteIndex = 0;
uint8_t I2C::txAddress = 0;

uint8_t I2C::txBuffer[BUFFER_LENGTH];
uint8_t I2C::txReadIndex = 0;
uint8_t I2C::txWriteIndex = 0;

uint8_t I2C::transmitting = 0;
uint8_t I2C::currentState = IDLE;

void(*I2C::user_onRequest)(void);
void(*I2C::user_onReceive)(int);

uint8_t I2C::i2cModule = NOT_ACTIVE;
uint8_t I2C::slaveAddress = 0;
// Constructors ////////////////////////////////////////////////////////////////
...
uint8_t I2C::getRxData(unsigned long cmd) {
...
uint8_t I2C::sendTxData(unsigned long cmd, uint8_t data) {
	while (ROM_I2CMasterBusy(MASTER_BASE));
...
void I2C::setModule(unsigned long _i2cModule)
{
